...
Two middleware functions by default which are are located in the `blog.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `blog.handler` namespace to manage the enabled middleware.
